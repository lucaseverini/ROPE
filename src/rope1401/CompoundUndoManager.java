/**
 * <p>Title: CompoundUndoManager.java</p>
 * <p>Description: </p>
...
public class CompoundUndoManager extends UndoManager implements UndoableEditListener, DocumentListener
{
	...
	public Action updateUndoAction;
	public Action updateRedoAction;
	...
	*/
	...
	{
		updateUndoAction.actionPerformed(new ActionEvent(this, ActionEvent.ACTION_PERFORMED, "UpdateUndo" ));
		updateRedoAction.actionPerformed(new ActionEvent(this, ActionEvent.ACTION_PERFORMED, "UpdateRedo" ));
